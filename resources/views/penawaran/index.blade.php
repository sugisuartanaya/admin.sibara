          ...
          <div class="col-sm-4">
              <div class="page-header float-left">
                  <div class="page-title">
                    <h1><i class="menu-icon fa fa-gavel" style="margin-right: 10px"></i>List Penawaran</h1>
                  </div>
              </div>
          </div>
          <div class="col-sm-8">
              <div class="page-header float-right">
                  <div class="page-title">
                      <ol class="breadcrumb text-right">
                          ...
                          <li class="active"><a href="/penawaran"></a>Penawaran</li>
                      </ol>
                  </div>
              </div>
          </div>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header d-flex justify-content-between align-items-center">
              <strong class="card-title mb-0">Penawaran Tiap Jadwal</strong>
          </div>
          <div class="card-body">
                ...
                @foreach ($data_jadwal as $index => $jadwal)
                  <tr>
                    ...
                    <td class="text-center align-middle">
                      <a href="/penawaran/{{ $jadwal->id }}" class="btn btn-success btn-sm" data-toggle="tooltip" data-original-title="Cek"><i class="menu-icon fa fa-eye"></i></a>
                    </td>
                  </tr>
                @endforeach                   
              </tbody>
