...
<html class="no-js" lang="">
  ...
  <p class="mb-0">Dengan disaksikan oleh:</p>
    ...
    @endforeach
    <br>
    <p style="text-align: justify;">Dilakukan penjualan langsung, dan telah menyerahkan Barang Rampasan berdasarkan Surat Perintah Penjualan Langsung Barang Rampasan Negara Nomor: {{ $penawaran->barang_rampasan->izin->no_sk }} tanggal {{ $tgl_sk }} berupa :</p>
