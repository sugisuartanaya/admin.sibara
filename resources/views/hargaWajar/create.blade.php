              ...
              <div class="page-header float-right">
                  <div class="page-title">
                      <ol class="breadcrumb text-right">
                          ...
                          <li class="active">Tambah Harga Wajar</li>
                      </ol>
                  </div>
              </div>
          </div>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <strong>Tambah Harga Wajar</strong>
          </div>
          <div class="card-body card-block">
            <form action="/harga-wajar/create/{{ $data_barang->id }}" method="post">
            @csrf

              <div class="form-group">
                <label for="no_laporan_penilaian" class=" form-control-label">No Laporan Penilaian</label>
                <input type="text" id="no_laporan_penilaian" name="no_laporan_penilaian" class="form-control @error('no_laporan_penilaian') is-invalid @enderror" value="{{ old('no_laporan_penilaian') }}">
              ...
              <div class="form-group">
                ...
                <input type="text" id="tanggal" name="tgl_laporan_penilaian" class="form-control datetimepicker-input @error('tgl_laporan_penilaian') is-invalid @enderror" value="{{ old('tgl_laporan_penilaian') }}" placeholder="Pilih Tanggal" data-target="#tanggal" data-toggle="datetimepicker">
